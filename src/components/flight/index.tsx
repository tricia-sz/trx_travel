...
import { Cards } from '@/components/flight/components/cards';
...
export function Flight() {
  return (
    <Container>
      <div className='flex justify-center items-center bg-slate-100 h-32 w-72 rounded-xl absolute bottom-[325px]'>
      ...
      <div className='w-[1180px] h-72 flex justify-center items-center gap-8 bg-slate-100 rounded-[50px] absolute bottom-[90px]'>
        <Cards />
